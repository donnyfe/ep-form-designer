...
<template>
	<el-form label-width="90px">
		...
		<el-form-item label="按钮文字">
			<el-input
				v-model="control.props.buttonText"
				clearable
				placeholder="请输入上传按钮的文字"
			></el-input>
		</el-form-item>
		...
		<el-form-item label="文件大小">
			<el-input
				type="number"
				:min="0"
				v-model="control.props.size"
				placeholder="文件大小,0为不限"
			>
				<template #append>
					<el-select
						style="width: 70px"
						v-model="control.props.sizeUnit"
						placeholder
					>
