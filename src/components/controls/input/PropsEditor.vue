...
<template>
	<el-form label-width="90px">
		...
		<el-form-item
			label="显示密码"
			v-if="control.props.type == 'password'"
		>
		...
		<el-form-item
			label="字数统计"
			v-if="control.props.type == 'text'"
		>
			<el-switch v-model="control.props.showWordLimit"></el-switch>
		</el-form-item>
		<el-form-item
			label="最大长度"
			v-if="control.props.showWordLimit"
		>
			<el-input-number
				v-model="control.props.maxlength"
				:min="1"
			/>
		</el-form-item>
		...
		<el-form-item
			label="必填提示"
			v-if="control.props.required"
		>
			<el-input
				@change="requiredMessageChange"
				v-model="control.props.requiredMessage"
			></el-input>
		</el-form-item>
		<el-form-item label="正则验证">
			<el-input
				@change="patternChange"
				v-model="control.props.pattern"
			></el-input>
		</el-form-item>
		<el-form-item
			label="正则提示"
			v-if="control.props.pattern"
		>
			<el-input
				@change="patternMessageChange"
				v-model="control.props.patternMessage"
			></el-input>
		</el-form-item>
