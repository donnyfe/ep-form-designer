...
<template>
	<el-form ref="form" class="form-renderer" :label-position="formData.props.labelPosition"
		:label-width="formData.props.labelWidth" :size="formData.props.size" :class="[formData.props.customClass]"
		:model="formModel" :status-icon="false">
		<FormItemRenderer :controls="formData.controls" :uploadOptions="uploadOptions" :formModel="formModel">
		</FormItemRenderer>
	</el-form>
</template>
