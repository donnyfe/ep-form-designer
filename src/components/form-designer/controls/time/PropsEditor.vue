...
<template>
	<el-form label-width="90px">
		...
		<el-form-item label="默认值">
			<el-time-select v-model="control.props.defaultValue" :start="control.props.start" :step="control.props.step"
				:end="control.props.end" placeholder="请选择默认值"></el-time-select>
		</el-form-item>
		...
		<el-form-item label="开始时间">
			<el-time-select v-model="control.props.start" start="00:00" :step="control.props.step" end="23:59"
				placeholder="请选择开始时间"></el-time-select>
		</el-form-item>
		<el-form-item label="结束时间">
			<el-time-select v-model="control.props.end" start="00:00" :step="control.props.step" end="23:59"
				placeholder="请选择结束时间"></el-time-select>
		</el-form-item>
		<el-form-item label="间隔时间">
			<el-time-select v-model="control.props.step" start="00:00" step="00:05" end="02:00"
				placeholder="请选择间隔时间"></el-time-select>
		</el-form-item>
