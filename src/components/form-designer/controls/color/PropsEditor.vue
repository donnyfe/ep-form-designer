	...
	<el-form label-width="90px">
		...
		<!-- <el-form-item label="尺寸">
			<el-radio-group v-model="control.props.size">
				<el-radio-button label="小" value="small"></el-radio-button>
				<el-radio-button label="默认" value="default"></el-radio-button>
				<el-radio-button label="大" value="large"></el-radio-button>
			</el-radio-group>
		</el-form-item> -->
		...
		<el-form-item label="默认值">
			<el-color-picker v-model="control.props.defaultValue" :show-alpha="control.props.showAlpha" />
		</el-form-item>
		...
		<el-form-item label-width="0">
			<draggable class="grid grid-cols-3 w-full" handle=".cursor-move" :list="control.props.options" item-key="index"
				tag="div">
				<template #item="{ element, index }">
					<div class="inline-flex items-center">
						...
						<el-color-picker v-model="element.value" :show-alpha="control.props.showAlpha" />
