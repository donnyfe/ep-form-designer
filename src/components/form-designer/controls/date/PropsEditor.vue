...
<template>
	<el-form label-width="90px">
		...
		<el-form-item label="默认值">
			<el-date-picker :type="control.props.type" v-model="control.props.defaultValue" placeholder="请选择默认值"
				:clearable="control.props.clearable" :value-format="control.props.format"
